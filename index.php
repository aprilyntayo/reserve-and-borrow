...
<head>
    ...
    <title>Reserve and Borrow System | Resource Management</title>
...
<body>
    ...
    <!-- HEADER / NAVBAR -->
    <header>
        <div class="logo"><i class="fas fa-calendar-check"></i> ReserveAndBorrowPro</div>
        <nav>
            <ul>
    ...
    <section class="hero" id="home">
        <div class="hero-text">
            <h1>Manage Your <span>Reservations and Borrowings</span> Efficiently</h1>
            <p>
                Streamline room reservations, equipment borrowing, and requests. 
    ...
    <!-- FOOTER -->
    <footer id="about">
        <p>&copy; <?php echo date('Y'); ?> Reserve and Borrow System. All Rights Reserved.</p>
